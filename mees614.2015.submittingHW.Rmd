...
+ Browse to the respository you want to use (e.g., `hw00`) and click `Create Project`
...
* Author your homework using R Markdown. The raw file should be saved (by default) with a `.rmd` extension. **Be sure to save the file in the correct local folder** (e.g., `hw00` for the first homework assignment.
...
1. Check that you have committed all the files associated with your HW assignment to your local Git repository (recall you should be saving these files in a folder named something like `hw00`).
...
8. On GitHub, navigate to the directory you created for the homework assignment (e.g., `hw00`).
...
Here is an example [README.md](https://github.com/fitzLab-AL/MEES614p/blob/master/README.md) that that links to other pages. Click on `Raw` to see how links are added.

### Make sure others (me) can reproduce your work with a few clicks...
1. In the very first chuck of R code, load all necessary packages
2. In the secodn chunck of code, load anything coming from external files. 
