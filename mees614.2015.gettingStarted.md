...
RStudio is a powerful and productive user interface for R that integrates coding, running scripts in R, plotting, help files, and Git versioning software (see next item). Download and install [RStudio](http://www.rstudio.com/). You want the **desktop** version for your system.

### Git & GitHub

Git is a file version control system and GitHub is an online Git resource for coding-based projects. We will use GitHub to track different versions of our R scripts, turn in homework assignments, and share code. There are multiple steps for setting up Git and GitHub for use in this course, as follows:

1. Download and install [Git](http://git-scm.com/) for your system. Think of this as background software that you will not use directly (but could). Git interfaces with RStudio (see below), but needs to be installed first.
2. Setup a [free GitHub account](https://github.com/join).
3. Download and install the GitHub GUI client for your system: [Mac](https://mac.github.com/) or [Windows](https://windows.github.com/). This software will serve as an interface between Rstudio and the online version of GitHub.
3. Using your newly created GitHub account, create the following *repository* (place where you will store your files on GitHub and, eventually, your local computer).
    ...
    + NOTE: Once you have an account, send me your user name and UID. I will create a second **private** repository that only you & I can see & where you will store homework and other assignments. This repository will be named `mees614-2015-UID`, replacing "UID" with your UID.
4. *Clone* both your **public** and **private** repositories to your personal computer. For my work, I clone repositories to a top-level folder named `...\code` - so mine would look something like `...\code\mees614-2015-UID` and `...\code\mees614-2015-lastname-firstname`.
